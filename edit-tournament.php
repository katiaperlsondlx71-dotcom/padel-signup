...
if (!isUserTournamentHost($tournamentId, $_SESSION['user_id'])) {
    showMessage('You are not authorized to edit this tournament', 'error');
    redirectTo('index.php');
}

// Check if players are registered to determine if max_participants can be edited
...
$canEditMaxParticipants = $registeredCount == 0;

// Set initial form data from tournament
$formData = [
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Update tournament if no errors
    if (empty($errors)) {
        $result = updateTournament($tournamentId, $formData, $_SESSION['user_id']);
        
        if ($result['success']) {
            showMessage($result['message'], 'success');
            redirectTo('tournament.php?t=' . $tournament['slug']);
        } else {
            $errors[] = $result['error'];
        }
    }
...
<head>
    ...
    <title>Edit Tournament - Padel Tournament Registration</title>
    <style>
        /* Reset */
        * {
            margin: 0;
    ...
    <div class="content-area">
        <div class="content-container">
            <div class="form-card">
                ...
                <?php if (!$canEditMaxParticipants): ?>
                    <div class="warning-message">
                        ⚠️ Players have already registered for this tournament. The maximum number of participants cannot be changed.
                    </div>
                <?php endif; ?>
                ...
                <form method="POST" action="">
                    ...
                    <div class="form-field">
                        ...
                        <input 
                            ...
                            <?php echo !$canEditMaxParticipants ? 'disabled' : ''; ?>
                        >
                        <?php if (!$canEditMaxParticipants): ?>
                            <input type="hidden" name="max_participants" value="<?php echo htmlspecialchars($formData['max_participants'] ?? 12); ?>">
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="form-actions">
                        <a href="tournament.php?t=<?php echo $tournament['slug']; ?>" class="btn-secondary">Cancel</a>
